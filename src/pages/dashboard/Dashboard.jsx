...
export function Dashboard() {
  ...
  return (
    ...
    >
      {isViewingAdmin && (
        <Box mt={1} mb={3}>
          <Typography variant="h5" fontWeight={700} color="#6F4E37" mb={2}>
            {cafeName} Analytics
          </Typography>
        </Box>
      )}
          ...
          <Grid container spacing={3} mt={5}>
            ...
            <Grid item size={{ xs: 12, md: 6 }}>
              <ChartCard
                title="Peak Time"
                action={
                  !isViewingAdmin && <DateRangeFilter onChange={setPeakRange} />
                }
              >
                <PeakTimeChart
                  range={peakRange}
                  overrideData={
                    isViewingAdmin ? analyticsResult?.peakTime : null
                  }
                  isViewingAdmin={isViewingAdmin}
                />
              </ChartCard>
