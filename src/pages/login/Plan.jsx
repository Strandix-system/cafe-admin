        ...
        >
            ...
            >
                <Typography
                    ...
                    fontWeight="700"
                    textAlign="center"
                    sx={{ color: "#3E2723", fontFamily: "'Playfair Display', serif", mb: 2 }}
                >
                    Be a Member
                </Typography>
                <Typography variant="body1" textAlign="center" sx={{ color: "#5D4037", mb: 4 }}>
                ...
                >
                    <Typography variant="h5" fontWeight="600" sx={{ color: "#3E2723", mb: 1 }}>
                        {plan.name}
                    </Typography>
